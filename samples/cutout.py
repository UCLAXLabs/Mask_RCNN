...
#PHOTODIR = '/home/broadwell/images/ucla_ua/'
PHOTODIR = '/home/broadwell/images/ucla_ua/resized/'
for img in os.listdir(PHOTODIR):
  image = skimage.io.imread(PHOTODIR + img)

  imgName = img.replace('uclalsc_uars100_', '')
  ...
  visualize.cut_out_masks(image, r['rois'], r['masks'], r['class_ids'], class_names, r['scores'], image_prefix=imgName)
